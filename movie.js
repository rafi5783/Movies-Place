...
const APILINK = 'http://localhost:8001/api/v1/reviews/';
...
returnReviews("http://localhost:8001/api/v1/reviews/");
...
function saveReview(reviewInputId, userInputId,id=""){
  ...
  if(id){  
    fetch("http://localhost:8001/api/v1/reviews/" + id, {
        method: 'PUT',
        headers: {
      ...
      .then(res => {
        ...
        fetch("http://localhost:8001/api/v1/reviews/" + "new", {
            method: 'POST',
            headers: {
                'Accept': 'application/json, text/plain, */*',
                'Content-Type': 'application/json'
